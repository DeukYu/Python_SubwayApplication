...
if(data['routes'][0]['legs'][0]['steps'][0]['travel_mode'] == 'TRANSIT'):
    print("시작역에서 " + data['routes'][0]['legs'][0]['steps'][0]['transit_details']['arrival_stop']['name'] + "까지 " + data['routes'][0]['legs'][0]['steps'][0]['transit_details']['line']['short_name'] + " " + data['routes'][0]['legs'][0]['steps'][0]['transit_details']['headsign'] + "행 열차 " + data['routes'][0]['legs'][0]['steps'][0]['transit_details']['departure_time']['text'] + " ~ " + data['routes'][0]['legs'][0]['steps'][0]['transit_details']['arrival_time']['text'] +", 지하철" + str(data['routes'][0]['legs'][0]['steps'][0]['transit_details']['num_stops']) + " 정거장")
...
for i in data2:
    if i['travel_mode'] == 'TRANSIT':
        print(i['transit_details']['departure_stop']['name'] + "에서 " + i['transit_details']['arrival_stop']['name'] + "까지 " + i['transit_details']['line']['short_name'] + " " + i['transit_details']['headsign'] + "행 열차 " + i['transit_details']['departure_time']['text'] + " ~ " + i['transit_details']['arrival_time']['text'] + ", 지하철" + str(i['transit_details']['num_stops']) + " 정거장")
